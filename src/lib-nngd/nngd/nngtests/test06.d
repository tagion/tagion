    ...
    @trusted class nng_test06_message : NNGTest {
        ...
        override string[] run() {
            ...
            try {
                ...
                rc = msg1.body_append!ushort(11);
                enforce(rc == 0);
                rc = msg1.body_append!uint(12);
                enforce(rc == 0);
                rc = msg1.body_append!ulong(13);
                enforce(rc == 0);
                rc = msg1.body_prepend(cast(ubyte[]) s);
                enforce(rc == 0);
            ...
            try {
                ...
                rc = msg2.body_append!ushort(11);
                enforce(rc == 0);
                rc = msg2.body_append!uint(12);
                enforce(rc == 0);
                rc = msg2.body_append!ulong(13);
                enforce(rc == 0);
                rc = msg2.body_prepend(cast(ubyte[]) s);
                enforce(rc == 0);
