...
${call BIN,tagionwave,TAGIONWAVE,$(LIBSSL) $(LIBSECP256K1) $(LIBP2PGOWRAPPER),$(ONETOOL)}
...
${call BIN,hibonutil,HIBONUTIL,$(LIBSSL) $(LIBSECP256K1) $(LIBP2PGOWRAPPER),$(ONETOOL)}
...
${call BIN,dartutil,DARTUTIL,$(LIBSSL) $(LIBSECP256K1) $(LIBP2PGOWRAPPER),$(ONETOOL)}
...
${call BIN,wasmutil,WASMUTIL,$(LIBSSL) $(LIBSECP256K1) $(LIBP2PGOWRAPPER)}
...
${call BIN,tagionwallet,TAGIONWALLET,$(LIBSSL) $(LIBSECP256K1) $(LIBP2PGOWRAPPER),$(ONETOOL)}
...
${call BIN,tagionlogservicetest,LOGSERVICETEST,$(LIBSSL) $(LIBSECP256K1) $(LIBP2PGOWRAPPER)}
...
${call BIN,tagionsubscription,SUBSCRIPTION,$(LIBSSL) $(LIBSECP256K1) $(LIBP2PGOWRAPPER)}

#
# Recorderchain utility
#
target-recorderchain: DFILES+=${shell find $(DSRC) -name "*.d" -a -path "*/src/bin-recorderchain/*" -a -not -path "*/unitdata/*" }
${call BIN,recorderchain,RECORDERCHAIN,$(LIBSSL) $(LIBSECP256K1) $(LIBP2PGOWRAPPER)}
...
${call BIN,tagionboot,TAGIONBOOT,$(LIBSSL) $(LIBSECP256K1) $(LIBP2PGOWRAPPER),$(ONETOOL)}
...
target-tagion:
${call BIN,tagion,TAGION,$(LIBSSL) $(LIBSECP256K1) $(LIBP2PGOWRAPPER)}
...
${call BIN,behaviour,BEHAVIOUR,$(LIBSSL) $(LIBSECP256K1) $(LIBP2PGOWRAPPER)}
