module tagion.crypto.secp256k1.c.secp256k1_bppp;
 ...
 */
secp256k1_bppp_generators* secp256k1_bppp_generators_create (
 ...
 */
secp256k1_bppp_generators* secp256k1_bppp_generators_parse (
    const(secp256k1_context)* ctx,
    const(ubyte)* data,
    size_t data_len);
 ...
 */
void secp256k1_bppp_generators_destroy (
    const(secp256k1_context)* ctx,
