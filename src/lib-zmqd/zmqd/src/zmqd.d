...
@safe:
    ...
    */
    @property bool more() {
        return !!getOption!int(ZMQ_RCVMORE);
    }
    ...
    */
    @property ulong threadAffinity() {
        return getOption!ulong(ZMQ_AFFINITY);
    }
    /// ditto
    @property void threadAffinity(ulong value) {
        setOption(ZMQ_AFFINITY, value);
    }

    /// ditto
    @property ubyte[] identity() {
        return getIdentity(new ubyte[255]);
    }
    /// ditto
    ubyte[] getIdentity(ubyte[] dest) {
        return getArrayOption(ZMQ_IDENTITY, dest);
    }
    /// ditto
    @property void identity(const ubyte[] value) {
        setArrayOption(ZMQ_IDENTITY, value);
    }
    /// ditto
    @property void identity(const char[] value) {
        setArrayOption(ZMQ_IDENTITY, value);
    }

    /// ditto
    @property int rate() {
        return getOption!int(ZMQ_RATE);
    }
    /// ditto
    @property void rate(int value) {
        setOption(ZMQ_RATE, value);
    }
    ...
    @property int sendBufferSize() {
        return getOption!int(ZMQ_SNDBUF);
    }
    /// ditto
    @property void sendBufferSize(int value) {
        setOption(ZMQ_SNDBUF, value);
    }

    /// ditto
    @property int receiveBufferSize() {
        return getOption!int(ZMQ_RCVBUF);
    }
    /// ditto
    @property void receiveBufferSize(int value) {
        setOption(ZMQ_RCVBUF, value);
    }

    /// ditto
    @property FD fd() {
        return getOption!FD(ZMQ_FD);
    }

    /// ditto
    @property PollFlags events() {
        return getOption!PollFlags(ZMQ_EVENTS);
    }

    /// ditto
    @property SocketType type() {
        return getOption!SocketType(ZMQ_TYPE);
    }
    ...
    @property int backlog() {
        return getOption!int(ZMQ_BACKLOG);
    }
    /// ditto
    @property void backlog(int value) {
        setOption(ZMQ_BACKLOG, value);
    }
    ...
    /// ditto
    @property long maxMsgSize() {
        return getOption!long(ZMQ_MAXMSGSIZE);
    }
    /// ditto
    @property void maxMsgSize(long value) {
        setOption(ZMQ_MAXMSGSIZE, value);
    }

    /// ditto
    @property int sendHWM() {
        return getOption!int(ZMQ_SNDHWM);
    }
    /// ditto
    @property void sendHWM(int value) {
        setOption(ZMQ_SNDHWM, value);
    }

    /// ditto
    @property int receiveHWM() {
        return getOption!int(ZMQ_RCVHWM);
    }
    /// ditto
    @property void receiveHWM(int value) {
        setOption(ZMQ_RCVHWM, value);
    }

    /// ditto
    @property int multicastHops() {
        return getOption!int(ZMQ_MULTICAST_HOPS);
    }
    /// ditto
    @property void multicastHops(int value) {
        setOption(ZMQ_MULTICAST_HOPS, value);
    }
    ...
    @property void routerMandatory(bool value) {
        setOption(ZMQ_ROUTER_MANDATORY, value ? 1 : 0);
    }

    /// ditto
    @property int tcpKeepalive() {
        return getOption!int(ZMQ_TCP_KEEPALIVE);
    }
    /// ditto
    @property void tcpKeepalive(int value) {
        setOption(ZMQ_TCP_KEEPALIVE, value);
    }

    /// ditto
    @property int tcpKeepaliveCnt() {
        return getOption!int(ZMQ_TCP_KEEPALIVE_CNT);
    }
    /// ditto
    @property void tcpKeepaliveCnt(int value) {
        setOption(ZMQ_TCP_KEEPALIVE_CNT, value);
    }

    /// ditto
    @property int tcpKeepaliveIdle() {
        return getOption!int(ZMQ_TCP_KEEPALIVE_IDLE);
    }
    /// ditto
    @property void tcpKeepaliveIdle(int value) {
        setOption(ZMQ_TCP_KEEPALIVE_IDLE, value);
    }

    /// ditto
    @property int tcpKeepaliveIntvl() {
        return getOption!int(ZMQ_TCP_KEEPALIVE_INTVL);
    }
    /// ditto
    @property void tcpKeepaliveIntvl(int value) {
        setOption(ZMQ_TCP_KEEPALIVE_INTVL, value);
    }

    /// ditto
    @property bool immediate() {
        return !!getOption!int(ZMQ_IMMEDIATE);
    }
    /// ditto
    @property void immediate(bool value) {
        setOption!int(ZMQ_IMMEDIATE, value ? 1 : 0);
    }

    /// ditto
    @property void xpubVerbose(bool value) {
        setOption(ZMQ_XPUB_VERBOSE, value ? 1 : 0);
    }

    /// ditto
    @property bool ipv6() {
        return !!getOption!int(ZMQ_IPV6);
    }
    /// ditto
    ...
    /// ditto
    @property bool plainServer() {
        return !!getOption!int(ZMQ_PLAIN_SERVER);
    }
    /// ditto
    @property void plainServer(bool value) {
        setOption(ZMQ_PLAIN_SERVER, value ? 1 : 0);
    }
    ...
    /// ditto
    @property bool curveServer() {
        return !!getOption!int(ZMQ_CURVE_SERVER);
    }
    /// ditto
    @property void curveServer(bool value) {
        setOption(ZMQ_CURVE_SERVER, value ? 1 : 0);
    }
    ...
    /// ditto
    @property void probeRouter(bool value) {
        setOption(ZMQ_PROBE_ROUTER, value ? 1 : 0);
    }

    /// ditto
    @property void reqCorrelate(bool value) {
        setOption(ZMQ_REQ_CORRELATE, value ? 1 : 0);
    }

    /// ditto
    @property void reqRelaxed(bool value) {
        setOption(ZMQ_REQ_RELAXED, value ? 1 : 0);
    }

    /// ditto
    @property void conflate(bool value) {
        setOption(ZMQ_CONFLATE, value ? 1 : 0);
    }

    /// ditto
    @property char[] zapDomain() {
        return getZapDomain(new char[256]);
    }
    /// ditto
    char[] getZapDomain(char[] dest) {
        return getCStringOption(ZMQ_ZAP_DOMAIN, dest);
    }
    /// ditto
    @property void zapDomain(const char[] value) {
        setArrayOption(ZMQ_ZAP_DOMAIN, value);
    }

    /// ditto
    @property void routerHandover(bool value) {
        setOption(ZMQ_ROUTER_HANDOVER, value ? 1 : 0);
    }

    /// ditto
    @property void connectionRID(const ubyte[] value) {
        setArrayOption(ZMQ_CONNECT_RID, value);
    }

    /// ditto
    @property int typeOfService() {
        return getOption!int(ZMQ_TOS);
    }
    /// ditto
    @property void typeOfService(int value) {
        setOption(ZMQ_TOS, value);
    }

    /// ditto
    @property bool gssapiPlaintext() {
        return !!getOption!int(ZMQ_GSSAPI_PLAINTEXT);
    }
    /// ditto
    @property void gssapiPlaintext(bool value) {
        setOption(ZMQ_GSSAPI_PLAINTEXT, value ? 1 : 0);
    }

    /// ditto
    @property char[] gssapiPrincipal() {
        return getGssapiPrincipal(new char[256]);
    }
    /// ditto
    char[] getGssapiPrincipal(char[] dest) {
        return getCStringOption(ZMQ_GSSAPI_PRINCIPAL, dest);
    }
    /// ditto
    @property void gssapiPrincipal(const char[] value) {
        setArrayOption(ZMQ_GSSAPI_PRINCIPAL, value);
    }

    /// ditto
    @property bool gssapiServer() {
        return !!getOption!int(ZMQ_GSSAPI_SERVER);
    }
    /// ditto
    @property void gssapiServer(bool value) {
        setOption(ZMQ_GSSAPI_SERVER, value ? 1 : 0);
    }

    /// ditto
    @property char[] gssapiServicePrincipal() {
        return getGssapiServicePrincipal(new char[256]);
    }
    /// ditto
    char[] getGssapiServicePrincipal(char[] dest) {
        return getCStringOption(ZMQ_GSSAPI_SERVICE_PRINCIPAL, dest);
    }
    /// ditto
    @property void gssapiServicePrincipal(const char[] value) {
        setArrayOption(ZMQ_GSSAPI_SERVICE_PRINCIPAL, value);
    }
    ...
    @property bool delayAttachOnConnect() {
        return !!getOption!int(ZMQ_DELAY_ATTACH_ON_CONNECT);
    }

    deprecated("Use the 'immediate' property instead")
    @property void delayAttachOnConnect(bool value) {
        setOption(ZMQ_DELAY_ATTACH_ON_CONNECT, value ? 1 : 0);
    }
    ...
    @property void ipv4Only(bool value) {
        ipv6 = !value;
    }
...
private:
    ...
    bool nothrowClose() nothrow {
        if (m_socket != null) {
            if (trusted!zmq_close(m_socket) != 0)
                return false;
            m_socket = null;
        }
        return true;
    ...
    T getOption(T)(int option) @trusted if (isScalarType!T) {
        T buf;
        auto len = T.sizeof;
    ...
    T[] getArrayOption(T)(int option, T[] buf) @trusted if (isScalarType!T) {
...
*/
char[] z85Encode(ubyte[] data, char[] dest) // TODO: Make data const when we update to ZMQ 4.1
{
    import core.exception : RangeError;

    immutable len = 5 * data.length / 4;
    if (dest.length < len + 1)
        throw new RangeError;
...
*/
ubyte[] z85Decode(char[] text, ubyte[] dest) // TODO: Make text const when we update to ZMQ 4.1
{
    import core.exception : RangeError;
...
curveKeyPair(char[] publicKeyBuf = null, char[] secretKeyBuf = null) {
    ...
    if (publicKeyBuf is null)
        publicKeyBuf = new char[41];
    else if (publicKeyBuf.length < 41)
        throw new RangeError;
    if (secretKeyBuf is null)
        secretKeyBuf = new char[41];
    else if (secretKeyBuf.length < 41)
        throw new RangeError;
