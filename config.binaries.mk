...
${call BIN,tagionwave,TAGIONWAVE,$(SSLIMPLEMENTATION) $(LIBSECP256K1) $(LIBP2PGOWRAPPER),$(ONETOOL)}
...
${call BIN,hibonutil,HIBONUTIL,$(SSLIMPLEMENTATION) $(LIBSECP256K1) $(LIBP2PGOWRAPPER),$(ONETOOL)}
...
${call BIN,dartutil,DARTUTIL,$(SSLIMPLEMENTATION) $(LIBSECP256K1) $(LIBP2PGOWRAPPER),$(ONETOOL)}
...
${call BIN,wasmutil,WASMUTIL,$(SSLIMPLEMENTATION) $(LIBSECP256K1) $(LIBP2PGOWRAPPER)}
...
${call BIN,tagionwallet,TAGIONWALLET,$(SSLIMPLEMENTATION) $(LIBSECP256K1) $(LIBP2PGOWRAPPER),$(ONETOOL)}
...
${call BIN,tagionlogservicetest,LOGSERVICETEST,$(SSLIMPLEMENTATION) $(LIBSECP256K1) $(LIBP2PGOWRAPPER)}
...
${call BIN,tagionsubscription,SUBSCRIPTION,$(SSLIMPLEMENTATION) $(LIBSECP256K1) $(LIBP2PGOWRAPPER)}

#
# Recorderchain utility
#
target-recorderchain: DFILES+=${shell find $(DSRC) -name "*.d" -a -path "*/src/bin-recorderchain/*" -a -not -path "*/unitdata/*" }
${call BIN,recorderchain,RECORDERCHAIN,$(SSLIMPLEMENTATION) $(LIBSECP256K1) $(LIBP2PGOWRAPPER)}
...
${call BIN,tagionboot,TAGIONBOOT,$(SSLIMPLEMENTATION) $(LIBSECP256K1) $(LIBP2PGOWRAPPER),$(ONETOOL)}
...
target-tagion:
${call BIN,tagion,TAGION,$(SSLIMPLEMENTATION) $(LIBSECP256K1) $(LIBP2PGOWRAPPER)}
...
${call BIN,behaviour,BEHAVIOUR,$(SSLIMPLEMENTATION) $(LIBSECP256K1) $(LIBP2PGOWRAPPER)}
