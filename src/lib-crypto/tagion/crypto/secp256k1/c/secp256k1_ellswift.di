module tagion.crypto.secp256k1.c.secp256k1_ellswift;
 ...
 */
alias secp256k1_ellswift_xdh_hash_function = int function (
    ubyte* output,
    const(ubyte)* x32,
    const(ubyte)* ell_a64,
    const(ubyte)* ell_b64,
...
extern __gshared const secp256k1_ellswift_xdh_hash_function secp256k1_ellswift_xdh_hash_function_prefix;
...
extern __gshared const secp256k1_ellswift_xdh_hash_function secp256k1_ellswift_xdh_hash_function_bip324;
...
int secp256k1_ellswift_create (
    const(secp256k1_context)* ctx,
    ubyte* ell64,
    const(ubyte)* seckey32,
    const(ubyte)* auxrnd32);
