...
${call debug.open, GENERATION (lib-testscope) $(UNIT_MAIN_TARGET)}
...
${call debug, Generated target: $(_UNIT_TARGET_FULL)}
...
${call debug.open, GENERATION (lib-testall) $(UNIT_MAIN_TARGET)}
...
${call debug.close, GENERATION (lib-testall) $(UNIT_MAIN_TARGET)}
endef