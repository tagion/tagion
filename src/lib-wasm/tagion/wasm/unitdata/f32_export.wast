(module
  (func $add (param $x f32) (param $y f32) (result f32) (f32.add (local.get $x) (local.get $y)))
  (func $sub (param $x f32) (param $y f32) (result f32) (f32.sub (local.get $x) (local.get $y)))
  (func $mul (param $x f32) (param $y f32) (result f32) (f32.mul (local.get $x) (local.get $y)))
  (func $div (param $x f32) (param $y f32) (result f32) (f32.div (local.get $x) (local.get $y)))
  (func $sqrt (param $x f32) (result f32) (f32.sqrt (local.get $x)))
  (func $min (param $x f32) (param $y f32) (result f32) (f32.min (local.get $x) (local.get $y)))
  (func $max (param $x f32) (param $y f32) (result f32) (f32.max (local.get $x) (local.get $y)))
  (func $ceil (param $x f32) (result f32) (f32.ceil (local.get $x)))
  (func $floor (param $x f32) (result f32) (f32.floor (local.get $x)))
  (func $trunc (param $x f32) (result f32) (f32.trunc (local.get $x)))
  (func $nearest (param $x f32) (result f32) (f32.nearest (local.get $x)))
  (func $abs (param $x f32) (result f32) (f32.abs (local.get $x)))
  (func $neg (param $x f32) (result f32) (f32.neg (local.get $x)))
  (func $copysign (param $x f32) (param $y f32) (result f32) (f32.copysign (local.get $x) (local.get $y)))
