module tagion.crypto.secp256k1.c.secp256k1_ecdsa_adaptor;
 ...
 */
alias secp256k1_nonce_function_hardened_ecdsa_adaptor = int function (
    ubyte* nonce32,
    const(ubyte)* msg32,
    const(ubyte)* key32,
    const(ubyte)* pk33,
 ...
 */
extern __gshared const secp256k1_nonce_function_hardened_ecdsa_adaptor secp256k1_nonce_function_ecdsa_adaptor;
