(module
  (func $i64.extend_s_i32 (param $x i32) (result i64) (i64.extend_s/i32 (local.get $x)))
  (export "i64.extend_s_i32" $i64.extend_s_i32)

  (func $i64.extend_u_i32 (param $x i32) (result i64) (i64.extend_u/i32 (local.get $x)))
  (export "i64.extend_u_i32" $i64.extend_u_i32)

  (func $i32.wrap_i64 (param $x i64) (result i32) (i32.wrap/i64 (local.get $x)))
  (export "i32.wrap_i64" $i32.wrap_i64)

  (func $i32.trunc_s_f32 (param $x f32) (result i32) (i32.trunc_s/f32 (local.get $x)))
  (export "i32.trunc_s_f32" $i32.trunc_s_f32)

  (func $i32.trunc_u_f32 (param $x f32) (result i32) (i32.trunc_u/f32 (local.get $x)))
  (export "i32.trunc_u_f32" $i32.trunc_u_f32)

  (func $i32.trunc_s_f64 (param $x f64) (result i32) (i32.trunc_s/f64 (local.get $x)))
  (export "i32.trunc_s_f64" $i32.trunc_s_f64)

  (func $i32.trunc_u_f64 (param $x f64) (result i32) (i32.trunc_u/f64 (local.get $x)))
  (export "i32.trunc_u_f64" $i32.trunc_u_f64)

  (func $i64.trunc_s_f32 (param $x f32) (result i64) (i64.trunc_s/f32 (local.get $x)))
  (export "i64.trunc_s_f32" $i64.trunc_s_f32)

  (func $i64.trunc_u_f32 (param $x f32) (result i64) (i64.trunc_u/f32 (local.get $x)))
  (export "i64.trunc_u_f32" $i64.trunc_u_f32)

  (func $i64.trunc_s_f64 (param $x f64) (result i64) (i64.trunc_s/f64 (local.get $x)))
  (export "i64.trunc_s_f64" $i64.trunc_s_f64)

  (func $i64.trunc_u_f64 (param $x f64) (result i64) (i64.trunc_u/f64 (local.get $x)))
  (export "i64.trunc_u_f64" $i64.trunc_u_f64)

  (func $f32.convert_s_i32 (param $x i32) (result f32) (f32.convert_s/i32 (local.get $x)))
  (export "f32.convert_s_i32" $f32.convert_s_i32)

  (func $f32.convert_s_i64 (param $x i64) (result f32) (f32.convert_s/i64 (local.get $x)))
  (export "f32.convert_s_i64" $f32.convert_s_i64)

  (func $f64.convert_s_i32 (param $x i32) (result f64) (f64.convert_s/i32 (local.get $x)))
  (export "f64.convert_s_i32" $f64.convert_s_i32)

  (func $f64.convert_s_i64 (param $x i64) (result f64) (f64.convert_s/i64 (local.get $x)))
  (export "f64.convert_s_i64" $f64.convert_s_i64)

  (func $f32.convert_u_i32 (param $x i32) (result f32) (f32.convert_u/i32 (local.get $x)))
  (export "f32.convert_u_i32" $f32.convert_u_i32)

  (func $f32.convert_u_i64 (param $x i64) (result f32) (f32.convert_u/i64 (local.get $x)))
  (export "f32.convert_u_i64" $f32.convert_u_i64)

  (func $f64.convert_u_i32 (param $x i32) (result f64) (f64.convert_u/i32 (local.get $x)))
  (export "f64.convert_u_i32" $f64.convert_u_i32)

  (func $f64.convert_u_i64 (param $x i64) (result f64) (f64.convert_u/i64 (local.get $x)))
  (export "f64.convert_u_i64" $f64.convert_u_i64)

  (func $f64.promote_f32 (param $x f32) (result f64) (f64.promote/f32 (local.get $x)))
  (export "f64.promote_f32" $f64.promote_f32)

  (func $f32.demote_f64 (param $x f64) (result f32) (f32.demote/f64 (local.get $x)))
  (export "f32.demote_f64" $f32.demote_f64)

  (func $f32.reinterpret_i32 (param $x i32) (result f32) (f32.reinterpret/i32 (local.get $x)))
  (export "f32.reinterpret_i32" $f32.reinterpret_i32)

  (func $f64.reinterpret_i64 (param $x i64) (result f64) (f64.reinterpret/i64 (local.get $x)))
  (export "f64.reinterpret_i64" $f64.reinterpret_i64)

  (func $i32.reinterpret_f32 (param $x f32) (result i32) (i32.reinterpret/f32 (local.get $x)))
  (export "i32.reinterpret_f32" $i32.reinterpret_f32)

  (func $i64.reinterpret_f64 (param $x f64) (result i64) (i64.reinterpret/f64 (local.get $x)))
