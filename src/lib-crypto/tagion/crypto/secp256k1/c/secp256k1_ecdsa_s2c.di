module tagion.crypto.secp256k1.c.secp256k1_ecdsa_s2c;
 ...
 */
struct secp256k1_ecdsa_s2c_opening
{
    ubyte[64] data;
}
 ...
 *
 */
int secp256k1_ecdsa_s2c_opening_parse (
 ...
 */
int secp256k1_anti_exfil_sign (
    const(secp256k1_context)* ctx,
    secp256k1_ecdsa_signature* sig,
    const(ubyte)* msg32,
    const(ubyte)* seckey,
    const(ubyte)* host_data32);
 ...
 */
int secp256k1_anti_exfil_host_verify (
    const(secp256k1_context)* ctx,
    const(secp256k1_ecdsa_signature)* sig,
    const(ubyte)* msg32,
