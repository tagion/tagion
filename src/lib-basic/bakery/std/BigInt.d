 ...
 * Source: $(PHOBOSSRC Bakery/std/_BigInt.d)
 */
...
@system unittest {
    // formattedWrite check for decimal
    import std.array;
    import std.format;
...
@system unittest {
    // formattedWrite check for small letter Hex
    import std.array;
    import std.format;
...
@system unittest {
    // formattedWrite check for big letter Hex
    import std.array;
    import std.format;
...
@system unittest {
    ...
    // Increament and Decrement around zero
    BigInt y = -3;
    ++y;
    assert(y.toLong() == -2);
    y = 1;
