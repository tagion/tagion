...
immutable(char)* nng_http_req_get_method(nng_http_req *);
immutable(char)* nng_http_req_get_version(nng_http_req *);
immutable(char)* nng_http_req_get_uri(nng_http_req *);
...
immutable(char)* nng_http_req_get_header(nng_http_req *, const char *);
...
immutable(char)* nng_http_res_get_reason(nng_http_res *);
...
immutable(char)* nng_http_res_get_header(nng_http_res *, const char *);
int nng_http_res_set_version(nng_http_res *, const char *);
immutable(char)* nng_http_res_get_version(nng_http_res *);
