...
shared static this() {
    with (IR) {
        instrTable = [
            ...
            GLOBAL_SET: Instr("global.set", 1, IRType.GLOBAL),/// memarg a                     :u32 o:u32 ⇒ {align a, offset o}
            ...
            MEMORY_GROW: Instr("memory.grow", 7, IRType.MEMOP),// Const instructions
            I32_CONST: Instr("i32.const", 1, IRType.CONST),
            I64_CONST: Instr("i64.const", 1, IRType.CONST),
            F32_CONST: Instr("f32.const", 1, IRType.CONST),
            F64_CONST: Instr("f64.const", 1, IRType.CONST),// Compare instructions
            ...
            F64_GE: Instr("f64.ge", 1, IRType.CODE),/// Operator                      instructions
            ...
            F64_COPYSIGN: Instr("f64.copysign", 1, IRType.CODE),/// Convert instructions
