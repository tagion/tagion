...
At the time of writing (find a timestamps of lastest updates on the bottom of all pages), the Tagion network is distributed across several nodes, but they are all on Decard servers and operate in what we call "Mode 1". We call this the **Pre-release Phase**. 
