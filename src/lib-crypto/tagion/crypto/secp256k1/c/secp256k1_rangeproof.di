module tagion.crypto.secp256k1.c.secp256k1_rangeproof;
 ...
 * and sanity checks.
 */
enum SECP256K1_RANGEPROOF_MAX_MESSAGE_LEN = 3968;
 ...
 */
size_t secp256k1_rangeproof_max_size (
    const(secp256k1_context)* ctx,
    ulong max_value,
    int min_bits);
