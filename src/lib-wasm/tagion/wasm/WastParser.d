...
struct WastParser {
    ...
    private ParserStage parseFuncArgs(ref WastTokenizer r, const ParserStage stage, ref FuncType func_type, ref scope int[string] params) {
        if (r.type == TokenType.BEGIN) {
            string label;
            string arg;
            r.nextToken;
