...
Tagion, as a network of distributed databases, has utility far beyond ledger based accounting. But to understand the concept and implementation of its _consensus_ mechanism it remains useful to consider its heritage. 
