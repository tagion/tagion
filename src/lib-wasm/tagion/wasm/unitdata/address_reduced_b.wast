...
(module
  ...
  (func (export "8u_bad") (param $i i32) (result i64)
    (i64.load8_u offset=4294967295 (local.get $i))
  )
  (func (export "8s_bad") (param $i i32) (result i64)
    (i64.load8_s offset=4294967295 (local.get $i))
  )
  (func (export "16u_bad") (param $i i32) (result i64)
    (i64.load16_u offset=4294967295 (local.get $i))
  )
  (func (export "16s_bad") (param $i i32) (result i64)
    (i64.load16_s offset=4294967295 (local.get $i))
  )
  (func (export "32u_bad") (param $i i32) (result i64)
    (i64.load32_u offset=4294967295 (local.get $i))
  )
  (func (export "32s_bad") (param $i i32) (result i64)
    (i64.load32_s offset=4294967295 (local.get $i))
  )
  (func (export "64_bad") (param $i i32) (result i64)
    (i64.load offset=4294967295 (local.get $i))
  )
)
