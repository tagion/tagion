...
DTMP_SECP256K1 := $(DTMP)/secp256k1/debug
else
DTMP_SECP256K1 := $(DTMP)/secp256k1/release/
endif

LIBSECP256K1:=$(DTMP_SECP256K1)src/$(LIBSECP256K1_FILE)
LIBSECP256K1_PRECOMPUTED:=$(DTMP_SECP256K1)/.libs/$(LIBSECP256K1_NAME)_precomputed.$(STAEXT)
...
$(LIBSECP256K1): $(DTMP_SECP256K1)/.way $(DLIB)/.way $(SECP256K1_HEAD)
	...
	${call log.kvp, $@}
	$(CD) $(DTMP_SECP256K1)
	$(CMAKE) $(DSRC_SECP256K1) $(addprefix -D,$(CONFIGUREFLAGS_SECP256K1))
