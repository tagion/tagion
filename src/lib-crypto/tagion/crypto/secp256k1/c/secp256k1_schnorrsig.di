 ...
 */
alias secp256k1_nonce_function_hardened = int function (
    ubyte* nonce32,
    const(ubyte)* msg,
    size_t msglen,
    const(ubyte)* key32,
    const(ubyte)* xonly_pk32,
    const(ubyte)* algo,
    size_t algolen,
    void* data);
 ...
 */
extern __gshared const secp256k1_nonce_function_hardened secp256k1_nonce_function_bip340;
