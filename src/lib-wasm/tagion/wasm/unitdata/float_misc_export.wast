(module
  (func $f32.add (param $x f32) (param $y f32) (result f32) (f32.add (local.get $x) (local.get $y)))
  (func $f32.sub (param $x f32) (param $y f32) (result f32) (f32.sub (local.get $x) (local.get $y)))
  (func $f32.mul (param $x f32) (param $y f32) (result f32) (f32.mul (local.get $x) (local.get $y)))
  (func $f32.div (param $x f32) (param $y f32) (result f32) (f32.div (local.get $x) (local.get $y)))
  (func $f32.sqrt (param $x f32) (result f32) (f32.sqrt (local.get $x)))
  (func $f32.abs (param $x f32) (result f32) (f32.abs (local.get $x)))
  (func $f32.neg (param $x f32) (result f32) (f32.neg (local.get $x)))
  (func $f32.copysign (param $x f32) (param $y f32) (result f32) (f32.copysign (local.get $x) (local.get $y)))
  (func $f32.ceil (param $x f32) (result f32) (f32.ceil (local.get $x)))
  (func $f32.floor (param $x f32) (result f32) (f32.floor (local.get $x)))
  (func $f32.trunc (param $x f32) (result f32) (f32.trunc (local.get $x)))
  (func $f32.nearest (param $x f32) (result f32) (f32.nearest (local.get $x)))

  (func $f64.add (param $x f64) (param $y f64) (result f64) (f64.add (local.get $x) (local.get $y)))
  (func $f64.sub (param $x f64) (param $y f64) (result f64) (f64.sub (local.get $x) (local.get $y)))
  (func $f64.mul (param $x f64) (param $y f64) (result f64) (f64.mul (local.get $x) (local.get $y)))
  (func $f64.div (param $x f64) (param $y f64) (result f64) (f64.div (local.get $x) (local.get $y)))
  (func $f64.sqrt (param $x f64) (result f64) (f64.sqrt (local.get $x)))
  (func $f64.abs (param $x f64) (result f64) (f64.abs (local.get $x)))
  (func $f64.neg (param $x f64) (result f64) (f64.neg (local.get $x)))
  (func $f64.copysign (param $x f64) (param $y f64) (result f64) (f64.copysign (local.get $x) (local.get $y)))
  (func $f64.ceil (param $x f64) (result f64) (f64.ceil (local.get $x)))
  (func $f64.floor (param $x f64) (result f64) (f64.floor (local.get $x)))
  (func $f64.trunc (param $x f64) (result f64) (f64.trunc (local.get $x)))
  (func $f64.nearest (param $x f64) (result f64) (f64.nearest (local.get $x)))
